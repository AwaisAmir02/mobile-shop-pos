@php
    ...
    $navItems = $isSuperAdmin
        ...
        : collect([
            ...
            ['label' => 'My SIMs', 'route' => 'sim-management.index', 'icon' => 'sim', 'permission' => 'sim-management'],
    ...
    $icons = [
        ...
        'sim' => 'M7.5 3.75h6.379a1.5 1.5 0 011.06.44l3.371 3.37a1.5 1.5 0 01.44 1.061V19.5a1.5 1.5 0 01-1.5 1.5h-9.75a1.5 1.5 0 01-1.5-1.5V5.25a1.5 1.5 0 011.5-1.5zM9 12.75h6m-6 3h3.75',
    ];
@endphp
